...
def get_a9_image_info(path,
    ...
    def map_func(idx):
        ...
        if velodyne:
            pc_info["velodyne_path"] = get_velodyne_path(idx, root_path, training, relative_path)

        if with_imageshape:
            raise ValueError("No with_imageshape in PROVID21")
