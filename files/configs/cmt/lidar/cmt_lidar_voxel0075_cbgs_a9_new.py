...
class_names = ['CAR', "TRAILER", "TRUCK", "VAN", "PEDESTRIAN", "BUS", "MOTORCYCLE", "OTHER", "BICYCLE"]
...
train_pipeline = [
    ...
    dict(
        ...
        db_sampler=dict(
            data_root=data_root,
            info_path=data_root + 'a9_nusc_dbinfos_train.pkl',
            rate=1.0,
            prepare=dict(
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file=data_root + '/a9_nusc_infos_test.pkl',
        # load_interval=1,
        pipeline=test_pipeline,
        classes=class_names,
        modality=input_modality,
