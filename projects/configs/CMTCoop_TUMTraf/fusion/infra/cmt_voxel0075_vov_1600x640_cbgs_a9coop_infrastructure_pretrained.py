...
train_pipeline = [
    ...
    dict(
        type='UnifiedObjectSampleCoop',
        sample_2d=True,
        mixup_rate=0.5,
        db_sampler=dict(
            type='UnifiedDataBaseSampler',
            data_root=data_root,
            info_path=data_root + 'a9_nusc_coop_dbinfos_train.pkl',
            rate=1.0,
            prepare=dict(
    ...
    dict(
        type='GlobalRotScaleTransAllCoop',
    ...
    dict(type='PointsRangeFilterCoop', point_cloud_range=point_cloud_range),
    ...
    dict(type='Collect3DCoop', keys=['vehicle_points', 'infrastructure_points', 'vehicle_img', 'infrastructure_img', 'gt_bboxes_3d', 'gt_labels_3d'],
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                with_label=False),
            dict(type='Collect3DCoop', keys=['vehicle_points', 'infrastructure_points', 'vehicle_img', 'infrastructure_img'],
                meta_keys=('filename', 'ori_shape', 'img_shape', 
                            'vehicle2infrastructure',
                            'vehicle_lidar2img',
                            'infrastructure_lidar2img',
...
optimizer_config = dict(
    type='CustomFp16OptimizerHookCoop',
...
log_level = 'INFO'
# work_dir = 'pretrained/cmt_a9_debug/fusion/infra/IL_cmt_lidar_voxel0075_cbgs_a9coop_infrastructure_loss_norm_pretrained_debug/IC_cmt_camera_vov_1600x640_cbgs_a9coop_infrastructure_loss_norm_pretrained_debug/cmt_voxel0075_vov_1600x640_cbgs_a9coop_infrastructure_loss_norm_debug_CL_pretrained'
# load_from= 'pretrained/cmt_a9_debug/fusion/infra/IL_cmt_lidar_voxel0075_cbgs_a9coop_infrastructure_loss_norm_pretrained_debug/IC_cmt_camera_vov_1600x640_cbgs_a9coop_infrastructure_loss_norm_pretrained_debug/cmt_voxel0075_vov_1600x640_cbgs_a9coop_infrastructure_loss_norm_debug_CL-pretrained.pth'
work_dir = 'pretrained/cmt_a9_debug/fusion/infra/IC_fcos3d_vovnet_imgbackbone-remapped/cmt_voxel0075_vov_1600x640_cbgs_a9coop_infrastructure_loss_norm_pretrained'
load_from = 'pretrained/cmt_a9_debug/camera/coop/IC_fcos3d_vovnet_imgbackbone-remapped/VC_fcos3d_vovnet_imgbackbone-remapped/cmt_camera_vov_1600x640_cbgs_a9coop_pretrained_loss_norm-pretrained.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
