...
log_level = 'INFO'
work_dir = 'pretrained/cmt_a9_debug/fusion/coop/IVL_cmt_lidar_voxel0075_cbgs_a9coop_loss_norm_debug_pretrained/IVC_cmt_camera_vov_1600x640_cbgs_a9coop_loss_norm_debug_pretrained/cmt_voxel0075_vov_1600x640_cbgs_a9coop_loss_norm_debug_pretrained'
load_from= 'pretrained/cmt_a9_debug/fusion/coop/IVL_cmt_lidar_voxel0075_cbgs_a9coop_loss_norm_debug_pretrained/IVC_cmt_camera_vov_1600x640_cbgs_a9coop_loss_norm_debug_pretrained/cmt_voxel0075_vov_1600x640_cbgs_a9coop_loss_norm_debug-pretrained.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = range(0, 8)
