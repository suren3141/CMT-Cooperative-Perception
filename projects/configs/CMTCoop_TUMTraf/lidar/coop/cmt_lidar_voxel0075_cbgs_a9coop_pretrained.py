...
train_pipeline = [
    ...
    dict(type='Collect3DCoop', 
         keys=['vehicle_points', 'infrastructure_points', 'gt_bboxes_3d', 'gt_labels_3d'],
        meta_keys=(
                    'vehicle2infrastructure',
                    'pcd_trans', 'pcd_scale_factor', 'pcd_rotation', 
                    'pts_filename', #suren 
                    'gt_bboxes_3d', 'gt_labels_3d'  # suren
                ))
]
test_pipeline = [
    dict(
    ...
    dict(
        ...
        transforms=[
            ...
            dict(
                ...
                with_label=False),
            dict(type='Collect3DCoop', 
                 keys=['vehicle_points', 'infrastructure_points'],
            ),
        ])
]
data = dict(
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        bbox_coder=dict(
            ...
            # post_center_range=[-61.2, -61.2, -10.0, 61.2, 61.2, 10.0], # TODO : Change 
...
log_level = 'INFO'
work_dir = 'pretrained/cmt_a9_debug/lidar/coop/IL_cmt_lidar_voxel0075_cbgs_a9coop_infrastructure_loss_norm_pretrained_debug/VL_cmt_lidar_voxel0075_cbgs_a9coop_vehicle_loss_norm_pretrained_debug/cmt_lidar_voxel0075_cbgs_a9coop_pretrained'
load_from = 'pretrained/cmt_a9_debug/lidar/coop/IL_cmt_lidar_voxel0075_cbgs_a9coop_infrastructure_loss_norm_pretrained_debug/VL_cmt_lidar_voxel0075_cbgs_a9coop_vehicle_loss_norm_pretrained_debug/cmt_lidar_voxel0075_cbgs_a9coop-pretrained.pth'
resume_from = None
workflow = [('train', 1)]
gpu_ids = [0]
